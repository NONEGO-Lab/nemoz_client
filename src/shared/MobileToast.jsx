...
const MobileToast = ({message,  isWebFullScreen}) => {
    ...
    if (type === 'warn') {
        return (
            <div
                className={"flex justify-center w-[50vw] items-center bg-black bg-opacity-[0.7] rounded-[22.5px] mt-[10px] h-[45.5px] mb-[10px]"}>
        ...
        return (
            isWebFullScreen ?
                ...
                <div
                    className={"flex justify-center items-center bg-black bg-opacity-[0.15] rounded-[22.5px] w-[45vw] h-[45.5px] mb-[10px]"}>
                    <span className={"text-[16px] text-white mr-[12.5px] my-[15px] flex items-center"}>
                                     <span
                                         className={"text-[34px]"}>{targetEmoji(msg.id)}</span>를 { msg.sender === 'member' ? '보냈습니다.' : "받았습니다."}
                                 </span>
                        ...
                        {/*<span className={"text-[16px] text-white mr-[12.5px] my-[15px] flex items-center"}>*/}
                        {/*             <span*/}
                        {/*                 className={"text-[34px]"}>{targetEmoji(msg.id)}</span>를 { msg.sender === 'artist' ? '보냈습니다.' : "받았습니다."}*/}
                        {/*         </span>*/}
