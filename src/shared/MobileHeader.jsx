...
const MobileHeader = () => {
    ...
    return (
        <div className="absolute top-0 left-0 w-[100vw] px-[30px]">
            <div
            className="flex items-center justify-between bg-[#ffffff] min-h-[55px] w-[100%] text-[#444444]">
            <div className=" flex justify-between items-center">
                <div
                    ...
                    <img src="../images/m-nemoz-call-logo.png" alt='header logo'/>
                </div>
