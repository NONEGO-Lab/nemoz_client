...
const CreateRoom = ({ setOnModal, getRoomListApi }) => {
  ...
  let style = "w-[600px] h-[870px] drop-shadow-md";
      ...
      <ModalFrame setOnModal={setOnModal} style={style}>
        <div className="px-[30px] pt-[30px]">
          ...
          <form className="mt-[30px]">
                ...
                if (roomInfo.type === "select") {
                  ...
                  return (
                      <div key={idx}>
                        ...
                        <div className="w-[400px] flex items-center mt-2 mb-[20px]
            ...
            <div className="flex flex-col items-start ${width} justify-center mt-[25px]">
              <label htmlFor={"fanList"} className="text-gray-400 text-[12px] mb-[10px]">
                팬목록
              </label>
              <Controller
