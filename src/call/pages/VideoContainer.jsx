...
//         publisher, publisherAudio, publisherVideo
//     } = useVideo();
//
//     const {
//         roomInfo, leftTimeRef, toastList,
...
//                                             <div className={"mr-4 cursor-pointer text-[12px]"}
...
//                                         return (
//                                             <div id={"sub"} key={i}
//                                                  className={`relative ${webFullScreenSize} h-[360px] border-2 border-box border-black m-auto flex`}>
//                                                 {
...
//                                     <Video streamManager={publisher}/>
//                                     <div
//                                         className={"absolute bottom-[-30px] font-bold text-lg"}>{userInfo.username}</div>
...
//                 {isOpenFanDetail &&
//                     <FanDetail currentFanId={waitingFanInfo.fan_id} setOnModal={() => setIsOpenFanDetail(false)}/>}
//             </SizeLayout>
//         )
//     }
// }
